...
var Script = (function() {
	...
	instance.spaceCompaneer = function()
	{
		...
		if (Script.phase >= 4) {Script.wonders.update(Script.wonders); Script.cons.addCons(Script.cons, "lunarite", 100); Script.cons.addCons(Script.cons, "titanium", 100); Script.cons.addCons(Script.cons, "silicon", 200);}
