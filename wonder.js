...
Script.wonders = (function(){
	...
	instance.wonders["precious2"] = {cost:{"gem":30000, "gold":10000, "silver":20000}, available:false, done:false, mk:activatePreciousWonder, unlocks:[], consequences:function(){self.wonders["energetic1"].available = true; Script.data.producerColumn = "uranium"; Script.energyTier = 5;}};
	...
	instance.wonders["energetic2"] = {cost:{"wood":30000, "charcoal":15000, "uranium":500}, available:false, done:false, mk:activatePreciousWonder, unlocks:[], consequences:function(){Script.data.producerColumn = "lava"; Script.energyTier = 6;}};
	...
	instance.update = function(self)
	{
		...
		for (id in self.wonders)
		{
			...
			if (self.wonder.available)
			{
				...
				{
					Script.cons.addCons(wonder.cost[key] / 100);
				}
			}
		}
	};
