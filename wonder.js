...
Script.wonders = (function(){
	...
	instance.wonders = {};
	instance.wonders["precious1"] = {cost:{"gem":10000, "gold":5000, "silver":7500}, available:true, done:false, mk:achievePreciousWonder, unlocks:["precious2"], consequences:function(){}};
	...
	instance.update = function(self)
	{
		...
		for (id in self.wonders)
		{
			...
			if (wonder.available && !wonder.done)
			{
				...
				{
					Script.cons.addCons(Script.cons, key, wonder.cost[key] / (50 * (1 + Math.log10(wonder.cost[key] / 2))));
				}
			}
		}
	};
