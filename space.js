...
Script.space = (function(){
	...
	instance.milestones["Mars"] = {requirements:{"rocketFuel":80}, available:false, done:false, unlocks:[], consequences:function(){Script.data.unlockResource(Script.data, "silicon"); Script.energy.data["methane"].unlocked = true;}};
	...
	instance.milestones["Saturn"] = {requirements:{"rocketFuel":2000}, available:false, done:false, unlocks:[], consequences:function(){Script.data.unlockResource(Script.data, "helium"); Script.energy.data["fusion"].unlocked = true; Script.science.techs["efficiencyResearch"].available = true;}};
